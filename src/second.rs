...
// pub will made this struct visible outside of this module
pub struct List<T> {
    head: Link<T>,
}
...
mod test {
    ...
    fn basics() {
        ...
        assert_eq!(list.pop(), Some(3.5));
        assert_eq!(list.pop(), Some(2.5));

        list.push(4.5);
        list.push(5.5);

        assert_eq!(list.pop(), Some(5.5));
        assert_eq!(list.pop(), Some(4.5));
